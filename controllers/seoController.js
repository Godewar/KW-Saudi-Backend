...
//   const { pageName, metaDescription, metaTitle, metaKeyword } = req.body;
...
//   const { pageName, metaDescription , metaTitle} = req.body;
...
// Create SEO
export const createSEO = async (req, res) => {
  const { pageName, metaDescription, metaTitle, metaKeywords } = req.body;
